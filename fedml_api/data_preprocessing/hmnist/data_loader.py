...
from .datasets import hmnist, hmnist_truncated
...
def partition_data(datadir, partition, n_nets, alpha, logger):
    ...
    df_train, y_train, df_test, y_test = load_hmnist_data(datadir)
...
def load_partition_data_hmnist(
    ...
    transform_train, transform_test = _data_transforms_hmnist()
    cache_train_data_set = hmnist(df_train, transform_train)
    cache_test_data_set = hmnist(df_test, transform_test)
    ...
    for client_idx in range(client_number):
        ...
        train_data_local, test_data_local = get_dataloader_hmnist(
            df_train,
            df_test,
            batch_size,
            batch_size,
