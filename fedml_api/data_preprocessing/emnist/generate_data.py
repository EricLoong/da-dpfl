...
# append root path to load files
...
with Path(root_path).joinpath("config.yaml").open('r') as fr:
...
N_CLASSES = 62
RAW_DATA_PATH = Path(root_path).joinpath("data")

PATH = "sample01/all_data/"
...
def main():
    ...
    print(f"number of train/val/test: {train_num}/ {val_num}/ {test_num}")
