...
class DittoAPI(object):
    ...
    def train(self):
        ...
        for round_idx in range(self.args.comm_round):
            ...
            for idx, client in enumerate(self.client_list):
                ...
                weights, training_flops, num_comm_params = client.train(
                    copy.deepcopy(w_global), round_idx
                )
                w_pers[client_idx] = client.local_train(
                    w_pers[client_idx], copy.deepcopy(w_global), round_idx
                )
    ...
    def _local_test_on_all_clients(self, w_pers, round_idx):
        ...
        test_acc = (
            sum(
                [
                    np.array(test_metrics["num_correct"][i])
